...
/**
 * An ImageView that loads from a URL via Coil with
 * tap-to-retry on failure and a 5-second auto-retry that re-arms every cycle (a persistently-failing
 * image keeps retrying). The SDK never fetches bytes — you load the URL. (Coil owns
 * memory/disk caching.)
 *
