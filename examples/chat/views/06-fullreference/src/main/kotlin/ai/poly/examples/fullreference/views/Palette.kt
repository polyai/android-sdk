...
/**
 * System color palette (light appearance) for bubbles, pills, banners and labels — gray scale,
 * yellow, blue, red, secondary label, and secondary background tones.
 */
internal object Palette {
    ...
    val secondaryLabel = Color.parseColor("#993C3C43") // secondary label ≈ black @ 60%
