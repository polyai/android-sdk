...
import ai.poly.examples.standard.views.databinding.ActivityChatBinding
...
/**
 * Rung 02 (Views) — the 80% chat. The classic-Views `02-Standard` screen: connection banner,
 * typing indicator, suggestion pills, delivery state + retry, End / Start-new chat, and a
...
class ChatActivity : ComponentActivity() {
    ...
    private fun refresh() {
        // Decide whether to follow BEFORE the list changes: follow only if the user is already
        // near the bottom, or just sent. Otherwise surface the pill.
    ...
    private fun scrollToBottom() {
        ...
        // newest item — the estimate-based scrollBy can under-scroll past tall rows.
