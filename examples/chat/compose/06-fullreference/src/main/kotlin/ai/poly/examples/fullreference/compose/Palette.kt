...
/**
 * System-color constants (light appearance) used to style the bubbles, pills, banner and labels.
 * Compose has no built-in palette for these, so these constants provide a consistent 1:1 set.
 */
