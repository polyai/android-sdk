...
/**
 * System-color palette (light appearance) used to style the
 * bubbles, pills and banner: grays, yellow, blue, red and the
 * secondary label.
 */
...
/** Teal (light) — the live-agent accent in 05-Handoff. */
internal val SystemTeal = Color(0xFF30B0C7)
