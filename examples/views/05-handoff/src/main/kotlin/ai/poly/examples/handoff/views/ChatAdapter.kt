...
import ai.poly.examples.handoff.views.databinding.ItemMessageBinding
import ai.poly.examples.handoff.views.databinding.ItemSuggestionsBinding
import ai.poly.examples.handoff.views.databinding.ItemTypingBinding
...
sealed interface ListItem {
    data class Message(val message: ChatMessage) : ListItem
