...
/**
 * Options for `PolyVoice.call`.
 *
 * Credentials live on `Configuration`, which is shared by messaging and voice. These are only
 * per-call dev / self-hosted and audio overrides, with working defaults for the standard regions.
...
public class VoiceOptions @JvmOverloads constructor(
    ...
    public class Builder {
        ...
        public fun build(): VoiceOptions =
            VoiceOptions(signalingHost = signalingHost, speakerphone = speakerphone)
    }
}
